...
This node captures images from multiple webcams and publishes them to ROS2 topics.
...
class WebcamPublisher(Node):
    def __init__(self):
        ...
        self.get_logger().info(f'Webcam publisher started with {len(self.cameras)} cameras at {PUBLISH_RATE} Hz')
